...
function setRegProp(){
    ...
    if(edocsIncomeDocumentNumber && edocsIncomeDocumentDate){
        ...
        if(EdocsApi.getAttributeValue('ClaimNumberCtrpt').value != edocsIncomeDocumentNumber)
            EdocsApi.setAttributeValue({code: 'ClaimNumberCtrpt', value: Number(edocsIncomeDocumentNumber), text: null});
        if(EdocsApi.getAttributeValue('ClaimDateCtrpt').value != moment(edocsIncomeDocumentDate).format('DD.MM.YYYY'))
            EdocsApi.setAttributeValue({code: 'ClaimDateCtrpt', value: moment(edocsIncomeDocumentDate).format('DD.MM.YYYY'), text: null});
    }
    else{
...
debugger
    ...
    if(table){
        var table2 = [], table3 = [], ClaimAmount2 = 0, ClaimAmount3 = 0, ClaimAmount4 = 0;
        table.forEach((row) => {
